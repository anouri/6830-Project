...
public class ApacheCommonsDBCPTest {
    ...
    public static void main(String[] args) {
    	...
    	QueryExecutorAll.create_table_cassandra("create keyspace test with replication = {'class':'SimpleStrategy','replication_factor':1}");
    	QueryExecutorAll.create_table_cassandra("CREATE TABLE test.example (a text,b text, PRIMARY KEY (a))");
