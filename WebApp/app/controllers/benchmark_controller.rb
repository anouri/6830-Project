...
class BenchmarkController < ApplicationController
  ...
  def column_distribution
		...
		SQLSchemaParser.new(@schema[:raw_schema])
		...
		QueryExecutorAll.dropTables(["follower", "message"])
  ...
  def queries
		...
		while !(data = fast_data_generator.generateMoreData()).nil? do
		  query_args = InsertData.QueryArgsFromJSON(data)
		  query_args.each do |qa|
			  result = QueryExecutorAll.bulk_run_insertion(qa)
